...
// -------------------------- CONFIG ----------------------------------
// Generated secrets (you can override via environment variables on Render)
const GENERATED_ADMIN_TOKEN = process.env.ADMIN_TOKEN || 'q9HfX2e7BzRkM8vP0sVnYcT4wLrJ6uF3ZdA1pQe8YmN5oU2xG0HtC7kLwS4bV1zA';
const GENERATED_COOKIE_SECRET = process.env.COOKIE_SECRET || 'c4d2e1f0b9a8c7d6e5f4a3b2c1d0e9f8';

const CONFIG = {
  // Ports (FIXED FOR RENDER: use environment PORT)
  PORT_HTTP: process.env.PORT ? parseInt(process.env.PORT, 10) : 10000,
  PORT_HTTPS: process.env.PORT_HTTPS ? parseInt(process.env.PORT_HTTPS, 10) : 8443,
  ...
  // Cookie/signing secret and admin token (can be overridden by env)
...
async function handleRequest(req, res) {
  ...
  if (pathname === '/admin' && method === 'GET') {
    ...
    if (token !== (process.env.ADMIN_TOKEN || CONFIG.ADMIN_TOKEN)) {
